/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a7ef1a65ac659b3300db7c7af206b58a)
// Runtime types generated with workerd@1.20250816.0 2025-08-20 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		LINK_BASE_URL: "http://localhost:5173" | "https://dev.kaiapay.app" | "https://kaiapay.app";
		DATABASE_URL: string;
		PRIVY_APP_ID: SecretsStoreSecret;
		PRIVY_APP_SECRET: SecretsStoreSecret;
		FEEPAYER_PK: SecretsStoreSecret;
		DATABASE: Hyperdrive;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LINK_BASE_URL" | "DATABASE_URL">> {}
}
