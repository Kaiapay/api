...
api.get("/api/tasks", TaskList);
api.post("/api/tasks", TaskCreate);
api.get("/api/tasks/:taskSlug", TaskFetch);
api.delete("/api/tasks/:taskSlug", TaskDelete);

api.get("/api/auth/me", AuthMe);
